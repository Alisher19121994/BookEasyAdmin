      ...
      body: Row(
        children: <Widget>[
          NavigationRail(
            ...
            selectedLabelTextStyle: const TextStyle(color: Color(0xff003290)),
            ...
            destinations: const [
              NavigationRailDestination(
                  indicatorColor: Color(0xff003290),
                  icon: Icon(Icons.home_outlined),
                  selectedIcon: Icon(Icons.home),
                  label: Text('Home',style: TextStyle(color: Color(0xff003290),fontSize: 12.0,fontWeight: FontWeight.bold),)),
              NavigationRailDestination(
                  indicatorColor: Color(0xff003290),
                  icon: Icon(Icons.favorite_border),
                  selectedIcon: Icon(Icons.favorite),
                  label: Text('Saved',style: TextStyle(color: Color(0xff003290),fontSize: 12.0,fontWeight: FontWeight.bold),)),
              NavigationRailDestination(
                  indicatorColor:Color(0xff003290),
                  icon: Icon(Icons.book_outlined),
                  selectedIcon: Icon(Icons.book),
                  label: Text('Bookings',style: TextStyle(color: Color(0xff003290),fontSize: 12.0,fontWeight: FontWeight.bold),)),
              NavigationRailDestination(
                indicatorColor: Color(0xff003290),
                  icon: Icon(Icons.perm_identity_rounded),
                  selectedIcon: Icon(Icons.person),
                  label: Text('Profile',style: TextStyle(color: Color(0xff003290),fontSize: 12.0,fontWeight: FontWeight.bold),)),
